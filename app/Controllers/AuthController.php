...
class AuthController extends BaseController
{
    ...
    public function login()
    {
        ...
        echo view('layouts/auth/header');
        echo view('auth/login', ['config' => $this->config]);
        echo view('layouts/auth/footer');
    ...
    public function attemptLogin()
    {
        ...
        if ($this->auth->user()->getRoles()[1] === 'admin') {
    ...
    public function register()
    {
        ...
        echo view('layouts/auth/header');
        echo view('auth/register', ['config' => $this->config]);
        echo view('layouts/auth/footer');
