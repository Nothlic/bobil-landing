            ...
            <div class="card report-card">
                <div class="card-body">
                    <div class="row d-flex justify-content-center">
                        <div class="col">
                            <p class="text-dark mb-1 fw-semibold">Total Visitor</p>
                            <h4 class="font-22 fw-bold">Coming Soon</h4>
                        </div>
        ...
        <div class="col-lg-4 col-sm-12">
            <div class="card report-card">
                <div class="card-body">
                    <div class="row d-flex justify-content-center">
                        <div class="col">
                            <p class="text-dark mb-1 fw-semibold">Total Clicked Cars</p>
                            <h4 class="font-22 fw-bold">Coming Soon</h4>
                        </div>
                        <div class="col-auto align-self-center">
                            <div class="bg-light-alt d-flex justify-content-center align-items-center thumb-md  rounded-circle">
                ...
                <div class="card-body">
                    <div class="row d-flex justify-content-center">
                        <div class="col">
                            ...
                            <p class="mb-0 text-truncate text-muted"><span class="text-success"><i class="mdi mdi-checkbox-marked-circle-outline me-1"></i></span>26
                                Project Complete</p>
                        </div>
                        <div class="col-auto align-self-center">
                            <div class="bg-light-alt d-flex justify-content-center align-items-center thumb-md  rounded-circle">
                ...
                <div class="card-body">
                    <div class="row d-flex justify-content-center">
                        <div class="col">
                            ...
                            <p class="mb-0 text-truncate text-muted"><span class="text-dark">$14k</span>
                                Total used budgets</p>
                        </div>
                        <div class="col-auto align-self-center">
                            <div class="bg-light-alt d-flex justify-content-center align-items-center thumb-md  rounded-circle">
            ...
            <div class="project-task-content">
                <div class="project-task-content-col">
                    <div class="project-task-content-inner">
                        ...
                        <div class="project-task-box" data-simplebar="">
                            <div class="project-task-card mb-3">
                                <div class="card-body">
                                    ...
                                    <p class="mb-2 text-muted fw-semibold font-13 text-break">Contrary to
                                        popular belief, Lorem Ipsum is not simply random text.</p>
                                    <hr class="hr-dashed">
                        ...
                        <!--End project-task-box-->
                    </div>
                    <!--End project-task-content-inner-->
                </div>
                <!--End project-task-content-Col-->
                <div class="project-task-content-col">
                    <div class="project-task-content-inner">
                        <div class="row">
                            <div class="col">
                ...
                <div class="project-task-content-col">
                    <div class="project-task-content-inner">
                        ...
                        <div class="row">
                            <div class="col">
                                <h5 class="text-uppercase font-15 font-weight-semibold mb-1">In Progress
                                </h5>
                                <h6 class="m-0">3 Issues - <span class="text-muted">20 Points</span></h6>
                            </div>
                            <!--End Col-->
